...
?>
          ...
          <li><a href="?page=datahasil"><i class="fa fa-sitemap fa-3x"></i>Hasil</a></li>
						...
						<li>
                        <a href="#"><i class="fa fa-edit fa-3x"></i> Mata Pelajaran<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <?php
            $best=mysql_query("SELECT * FROM kategori WHERE aktif='Y' ORDER BY id_kategori DESC");
