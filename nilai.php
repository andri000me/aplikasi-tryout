...
?>
 ...
 <div class="col-md-13">
	...
	$z=mysql_fetch_array(mysql_query("select * from kategori where id_kategori ='$row[id_kategori]'"));
		?>
	  <tr>
          ...
          <td><span class="btn btn-default btn-lg"><?php echo $row['point'];?></span></td>
		   <td><?php if  ($row['point'] >75) { 
											  echo "<span class='btn btn-success btn-lg'>Lulus</span>";
											  } else {
											  echo"<span class='btn btn-danger btn-lg'>Tidak Lulus</span>";}?></td>
