...
?>  
		...
		<tr>
			<td><span class="text-muted color-bottom-txt"><i class="fa fa-edit"></i>Kosong</span></td> <td> = <span class="btn btn-warning btn-lg"><?php echo $kosong;?></span> soal </td>
		</tr>
		<tr>
			<td><span class="text-muted color-bottom-txt"><i class="fa fa-edit"></i><b>Score</b></span></td><td>= <span class="btn btn-primary btn-lg"><b><?php echo $score;?></b></span> Point</td>
		</tr>
		</table> 
