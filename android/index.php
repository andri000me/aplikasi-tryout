...
if (isset($_POST['login'])){
	...
	$login=mysql_query("select * from tabel_user where username='$username' and password='$password'");
    ...
    <div id="containerr">
      <div id="contentt">
        <div id="loginBox">
          ...
          <p><?php  if(isset($_GET['status'])){ echo $_GET['status']; }?></p>
          ...
          <form action="index.php" method="post" name="postform">
            ...
            <div class="MBbuttonLogin">
              <input type="submit" id="loginButton" class="button" value="LOGIN" name="login" />
            </div>
          </form>
          <div class="close" />
