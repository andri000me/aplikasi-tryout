...
if(strlen($Gambar)>0){
	...
	if ($username=="" || $password=="" || $nisn=="" || $notlp=="" || $alamat=="" || $nama=="")
	{
		...
		$alamatfile="./gambar/user_online.jpg";
			...
			$upload=mysql_query("INSERT INTO tabel_user VALUES('','$nama','$alamatfile','$username','$password','$nisn','$notlp','$alamat','$Gambar')");
